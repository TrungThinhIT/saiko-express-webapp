...
class RQ_TKController extends Controller
{
    ...
    public function quanhuyen(Request $request)
    {
        ...
        $provinces = Http::withHeaders($header)->get('https://dev-notification.tomonisolution.com/api/districts', $param);
    ...
    public function phuongxa(Request $request)
    {
        ...
        $provinces = Http::withHeaders($header)->get('https://dev-notification.tomonisolution.com/api/wards', $param);
