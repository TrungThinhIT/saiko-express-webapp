...
class FLTrackingController extends Controller
{
    ...
    public function getStatus(Request $request)
    {
        ...
        if ($apiShow->status() == 404) {
            ...
            $vnpost = ['tongtien' => '12312312', 'code' => 'á1231231212', 'Mã' => '1231232'];
            ...
            if (!empty($results['data'][0]['boxes'])  && !empty($results['data'][0]['orders'])) {
                ...
                $arrCheck = ['Nhận tại VP Sóc Sơn', 'Nhận tại VP Đào Tấn', 'Nhận tại VP Tân Bình HCM', 'Nhận tại VP Lạc Long Quân', 'Nhận tại VP Hồ Chí Minh', 'VN Ha Noi', 'VN Sai Gon'];
                dd($results['data'][0]['orders'][0]['shipment_infor']['address']);
                if (!(in_array($results['data'][0]['orders'][0]['shipment_infor']['address'], $arrCheck))) {
                    ...
                    if (!empty($getWard)) {
                        ...
                        for ($i = 0; $i <= count($results['data'][0]['boxes']) - 1; $i++) {
                            ...
                            array_push($results['data'][0]['boxes'][$i], $results_vnpost);
                            sleep(1);
                        }
                    }
                }
