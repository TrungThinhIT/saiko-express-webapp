...
class FLTrackingController extends Controller
{
    ...
    public function getStatus(Request $request)
    {
        ...
        if ($apiShow->status() == 404) {
            ...
            //vnpost
            // if (!empty($results['boxes']) && !empty($results['orders'])) {
            //     usort($results['orders'], function ($a, $b) {
            //         return $b['shipment_infor_id'] - $a['shipment_infor_id'];
            //     }); //sort orders
            //     //vnpost
            ...
            //     if (!(in_array($results['orders'][0]['shipment_infor']['address'], $arrCheck))) {
            ...
            //                     'Weight' => $results['boxes'][$i]['weight_per_box'] * 1000,
            //                     'Width' => $results['boxes'][$i]['width'],
            //                     'Length' => $results['boxes'][$i]['length'],
            //                     'Height' => $results['boxes'][$i]['height'],
            //                     'CodAmount' => 1,
            ...
            //     );
            //     $results['boxes'][$i]['vnpost'] = $results_vnpost;
            // }
            //             }
            //         }
            //     }
