    ...
    <div class="card fix-overflow">
        ...
        <div class="card-body custom-background set-overflow">
            <div class="row align-items-center">
                ...
                <div class="col-md-1">
                    <button type="button" class="btn btn-secondary form-control text-center " id="reset_order">reset</button>
                </div>
                <div class="col-md-1">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.detail-order', async function(event) {
        ...
        $("#select_search").change(async function() {
    ...
    async function fetch_data_order(page) {
        await verifyToken();
        $.ajax({
            type: "GET",
            url: "{{ route('orders.index') }}",
